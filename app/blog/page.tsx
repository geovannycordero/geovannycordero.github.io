      ...
      <div className="mb-8 p-4 bg-emerald-50 rounded-lg border border-emerald-100">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <p className="text-sage-700">
            <span className="font-semibold text-emerald-700">{posts.length}</span> articles available
          </p>
      ...
      {posts.length === 0 && (
        <div className="text-center py-16">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-xl font-semibold mb-3 text-sage-900">No posts found</h3>
...
export default async function BlogPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <BlogNavigationHandler scrollTargetId="blog-content" headerOffset={100} enableDebugLogs={false} />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <div>
                  <h1 className="text-4xl font-bold text-sage-900 mb-2">Blog</h1>
                  <p className="text-lg text-sage-700">
                    Insights, articles, and updates on software development, technology, and leadership.
                  </p>
                </div>
            ...
            <div className="text-center mt-16 pt-8 border-t border-emerald-100">
              <div className="max-w-2xl mx-auto">
                <h3 className="text-lg font-semibold mb-4 text-sage-900">Stay Connected</h3>
                <p className="text-sage-700 mb-6">
