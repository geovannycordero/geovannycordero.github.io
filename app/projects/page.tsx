...
import { getSideProjects } from '@/lib/projects';
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i} className='animate-pulse'>
          <div className='bg-card border border-line dark:border-line/20 rounded-lg shadow-sm'>
            <div className='h-48 bg-accent-soft rounded-t-lg'></div>
            <div className='p-6 space-y-4'>
              <div className='flex justify-between items-start'>
                <div className='h-6 w-3/4 bg-accent-soft rounded'></div>
                <div className='h-4 w-16 bg-accent-soft rounded'></div>
              </div>
              <div className='h-4 w-20 bg-accent-soft rounded'></div>
              <div className='space-y-2'>
                <div className='h-4 bg-accent-soft rounded'></div>
                <div className='h-4 bg-accent-soft rounded'></div>
                <div className='h-4 bg-accent-soft rounded w-2/3'></div>
              </div>
              <div className='flex gap-2'>
                <div className='h-6 w-16 bg-accent-soft rounded'></div>
                <div className='h-6 w-20 bg-accent-soft rounded'></div>
                <div className='h-6 w-14 bg-accent-soft rounded'></div>
              </div>
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            <div className='mb-8'>
              ...
              <div className='text-left mb-6'>
                ...
                <p className='text-lg text-ink-muted'>
                  Personal builds and work delivered directly through an
                  employer — smaller in scope than the client engagements below,
                  but shipped and live.
                </p>
              </div>
              ...
              >
                Looking for client work? See case studies
                <ArrowRight className='h-4 w-4' />
              </Link>
            </div>

            {/* Projects content wrapper */}
            <div id='projects-content' className='scroll-mt-24 mt-8'>
            ...
            <div className='text-center mt-16 pt-8 border-t border-line dark:border-line/20'>
              <div className='max-w-2xl mx-auto'>
                ...
                <Link
                  href='/#contact'
                  className='inline-flex items-center px-6 py-3 bg-ink text-paper rounded-sm hover:opacity-80 transition-opacity font-medium dark:bg-accent-brand'
                >
                  Get In Touch
                </Link>
              </div>
