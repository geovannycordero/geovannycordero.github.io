  ...
  if (variant === "button") {
    return (
      ...
      >
        ...
        />
        {showLabel && <span className="text-sm font-medium">{resolvedTheme === "dark" ? "Light" : "Dark"}</span>}
      </Button>
    )
  }
    ...
    <DropdownMenu>
      ...
      >
        ...
        >
          ...
          <span>Light</span>
          {theme === "light" && <div className="ml-auto h-2 w-2 rounded-full bg-emerald-600" />}
        </DropdownMenuItem>
        <DropdownMenuItem
        ...
        >
          ...
          <span>Dark</span>
          {theme === "dark" && <div className="ml-auto h-2 w-2 rounded-full bg-emerald-600" />}
        </DropdownMenuItem>
        <DropdownMenuItem
        ...
        >
          ...
          <span>System</span>
          {theme === "system" && <div className="ml-auto h-2 w-2 rounded-full bg-emerald-600" />}
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  )
