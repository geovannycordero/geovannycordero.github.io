        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl sm:text-2xl text-emerald-700 font-medium">Full-Stack Software Engineer</p>
            ...
            <p className="text-lg text-sage-700 leading-relaxed">
              Passionate Full-Stack Software Engineer with 5+ years of experience, specializing in Golang, Ruby on
              Rails, and JavaScript technologies. Proven expertise in leading teams and delivering high-quality software
              solutions.
            </p>
