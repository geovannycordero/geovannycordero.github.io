const { THEME_INIT_SCRIPT, THEME_STORAGE_KEY } = require('../../build/theme-script');

function run(storedValue, systemPrefersDark) {
...
describe('THEME_INIT_SCRIPT', () => {
  it('uses the same storage key the client theme toggle persists to', () => {
