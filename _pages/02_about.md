...
I’m also passionate about physical activities like hiking, walking outdoors, cycling, and hitting the gym.

### Education

I hold a Bachelor's Degree in Computer Science from the University of Costa Rica ([UCR](https://www.ucr.ac.cr/)) and am currently pursuing a Master of Business Administration at the Universidad Estatal a Distancia ([UNED](https://www.uned.ac.cr/)).
...
In terms of cloud platforms, I have experience with AWS services, particularly EC2, S3, ECR, ECS, Route 53, VPCs, Security Groups, and Load Balancers, among others. I have built and maintained entire infraestrutures using AWS, including setting up CI/CD pipelines and all the deployment process.
